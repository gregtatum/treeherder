...
const TreeViewHeader = (
  { fixedColumns, mainColumn } /*:: : TreeViewHeaderProps */,
) => {
...
class TreeViewRowFixedColumns /*:: <DisplayData: Object> */ extends React.PureComponent /*:: <TreeViewRowFixedColumnsProps<DisplayData>> */ {
  ...
  render() {
    ...
    // Build up the classNames.
    const classNames = ['treeViewRow', 'treeViewRowFixedColumns'];
    classNames.push(index % 2 === 0 ? 'even' : 'odd');
    if (isSelected) {
      classNames.push('isSelected');
    }
    if (isRightClicked) {
      classNames.push('isRightClicked');
    }
...
|};
*/
class TreeViewRowScrolledColumns /*:: <DisplayData: Object> */ extends React.PureComponent /*:: <TreeViewRowScrolledColumnsProps<DisplayData>> */ {
  /**
  ...
  render() {
    ...
    const classNames = ['treeViewRow', 'treeViewRowScrolledColumns'];
    classNames.push(index % 2 === 0 ? 'even' : 'odd');
    if (isSelected) {
      classNames.push('isSelected');
    }
...
|};
*/
class TreeView /*:: <DisplayData: Object> */ extends React.PureComponent /*:: <TreeViewProps<DisplayData>> */ {
  /*::
  ...
  */
  ...
  UNSAFE_componentWillReceiveProps(
    nextProps /*:: : TreeViewProps<DisplayData> */,
  ) {
  ...
  _onCopy = (event) => {
    ...
    if (selectedNodeId) {
      ...
      const { clipboardData } = event; /*:: : Object */
    ...
    if (isNavigationKey) {
      switch (event.key) {
        ...
        case 'ArrowRight': {
          ...
          if (isCollapsed) {
            this._toggle(selected);
          } else if (this.props.tree.hasChildren(selected)) {
